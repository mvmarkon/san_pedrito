...
export const NuevaPrenda = () => {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">{id ? 'Editar Prenda' : 'Nueva Prenda'}</h1>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="categoria" className="block text-sm font-medium text-foreground">Categoría</label>
          <select
            id="categoria"
            value={categoria}
        ...
        <div>
          <label htmlFor="precioCosto" className="block text-sm font-medium text-foreground">Precio Costo</label>
          <input
            type="number"
            id="precioCosto"
            value={precioCosto}
        ...
        <div>
          <label htmlFor="precioVenta" className="block text-sm font-medium text-foreground">Precio Venta</label>
          <input
            type="number"
            id="precioVenta"
            value={precioVenta}
        ...
        <div>
          <label htmlFor="genero" className="block text-sm font-medium text-foreground">Género</label>
          <select
            id="genero"
            value={genero}
        ...
        <div>
          <label htmlFor="imagenPrincipal" className="block text-sm font-medium text-foreground">Imagen Principal</label>
          <input
            type="file"
            id="imagenPrincipal"
            onChange={(e) => setImagenPrincipal(e.target.files ? e.target.files[0] : null)}
          ...
          {id && existingImages.length > 0 && (
            <div className="mt-2">
              <h3 className="text-sm font-medium text-foreground">Imágenes Existentes:</h3>
              <div className="mt-2 grid grid-cols-4 gap-2">
                {existingImages.map((img) => (
                  <div key={img.id} className="relative w-24 h-24 overflow-hidden rounded-md">
                    <img
                      src={img.imagen}
        ...
        <div>
          <label htmlFor="imagenes" className="block text-sm font-medium text-foreground">Imágenes Adicionales</label>
          <input
            type="file"
            id="imagenes"
            multiple
